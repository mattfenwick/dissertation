...
\begin{figure}[h]
  \includegraphics[scale=0.35]{nhsqc}
...
\begin{figure}
  \includegraphics[scale=0.35]{nhsqc_peaks}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_nhsqc}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hncacb}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_cbcaconh}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hnco}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hncaco}
...
\begin{figure}
  \includegraphics[scale=0.3]{nhsqc_hncacb}
...
\begin{figure}
  \includegraphics[scale=0.35]{hncacb_overlap}
  \caption{Overlap of Carbon resonances in an HNCACB spectrum.}
  \label{hncacb_overlap}
\end{figure}

\begin{figure}
  \includegraphics[scale=0.45]{ss-residue}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hbhaconh}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hcconhtocsy}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_cconhtocsy}
...
\begin{figure}
  \includegraphics[scale=0.75]{ccpn_hcchtocsy}
