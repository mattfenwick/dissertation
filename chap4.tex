...
\begin{verbatim}
peaks       := aromatic_gnoesy_chsqc.pks,aromatic_noesy.pks,D2O_noesy_chsqc.pks,noesy_nhsqc.pks  # NOESY peak lists in XEASY for
mat
...
% making mistakes -- poor phasing, implicit atomtype assignments instead of explicit (i vs. i-1),
%   distinguishing between signal, noise, and artifact; extra spin systems
