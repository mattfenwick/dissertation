...
the RNMRTK implementation \cite{rnmrtk}.
...
% TODO add a picture of the data model
...
For an example, see Figures \ref{schedule_parameters} and \ref{schedule_data}.
% TODO cover the architecture -- how did I write it to so awesomely allow
%   all these combinations seamlessly?
% TODO add more discussion of the context, significance, and future value
% TODO add a picture of the parameters
%   then explain some of the parameters
% TODO mention that it was used to generate data for the PNAS paper
% TODO include a picture of a sample schedule, both in textual and in
%   plotted form.  point out features like decay, randomness
