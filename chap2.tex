...
The gyromagnetic ratio of nucleus (see Table-\ref{gyromagnetic_ratios}) and 
pulse sequences.  
...
The specific H, N, and C labeling pattern.
...
\begin{figure}
  \includegraphics[scale=0.35]{figures/schedule_uniform}
...
\begin{figure}
  \includegraphics[scale=0.35]{figures/schedule_nonuniform}
