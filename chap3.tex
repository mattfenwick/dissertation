...
SVN \cite{svn}, and CVS \cite{cvs}.  The
general properties of the solution are a sequence of snapshots of the data set,
...
When multiple snapshots are captured, they can be compared,
