...
\section{An overview of NMR data}

\subsection{Molecule}
pre-known
 - sequence, residues, atoms
 - bond lengths
desired 
 - bond angles
 - coordinates
...
\subsection{Sample}
??? concentration, components, preparation ???
...
pre-known
 ...
 - gyromagnetic ratios
 - pulse sequences
 - expected peak spin systems
collected data
 - 
spectra
 - peak: volume
 - peak dim: position, width, shape
 - concept of a resonance frequency (same frequency in all experiments)
unknown
 - correspondence between resonances and atoms
