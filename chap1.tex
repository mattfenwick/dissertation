...
\begin{itemize}
  ...
  Good Manufacturing Practices (GMPs), intended to help ensure quality and
...
reproducibility and their dissemination.  However, 
omputational results are often irreproducible due to missing code and data;
