...
because of (see Figure-\ref{primary_meta_data} and Figure-\ref{bmrb_deposited}):
\begin{itemize}
...
\begin{figure}
  \includegraphics[scale=0.5]{figures/primary_meta_data}
  \caption[Primary and meta data of the analysis process]
          {Primary (red) and meta (green) data of the analysis process.
           Note that the primary data forms a sequential chain, reflecting
           the modifications that are made during the process.}
  \label{primary_meta_data}
\end{figure}

\begin{figure}
  \includegraphics[scale=0.5]{figures/bmrb_deposited}
  \caption[Data which is deposited in the BMRB]
          {Data which is deposited in the BMRB does not include intermediate
           primary data, nor meta data.}
  \label{bmrb_deposited}
\end{figure}
